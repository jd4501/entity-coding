...
> **Additions in this fork.** This directory is a vendored copy of [`JoakimEdin/explainable-medical-coding`](https://github.com/JoakimEdin/explainable-medical-coding) at commit [`8269cc7`](https://github.com/JoakimEdin/explainable-medical-coding/commit/8269cc7246b88fa5dd299191713ed7475b908537), used by the parent repo for the ACL 2025 paper _Less is More: Explainable and Efficient ICD Code Prediction with Clinical Entities_. Please see `FORK_NOTES.md` for an explanation of changes. The `README.md` file here pertains to the original codebase, though most details remain relevant.
